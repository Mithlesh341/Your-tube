...
const CommentsFullScreen = forwardRef<HTMLDivElement, CommentsFullScreenProps>(
  ({ videoId, onClose }, ref) => {
    ...
    return (
      ...
      >
        ...
        <div className="p-4 mt-12 max-w-screen-md mx-auto">
          <h2 className="text-2xl font-semibold mb-4">Comments</h2>
          {/* Render your comments + input box here */}
          {user && (
...
CommentsFullScreen.displayName = "CommentsFullScreen";
