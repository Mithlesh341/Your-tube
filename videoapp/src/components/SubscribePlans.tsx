...
const SubscribePlans = () => {
    ...
    try {
      ...
      const options = {
        ...
        handler: async function (response: any) {
          // 3. On successful payment, verify and update user
  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 px-4 sm:px-6">
      <div className="bg-white rounded-2xl p-4 sm:p-6 w-full max-w-3xl relative shadow-lg overflow-y-auto max-h-[90vh]">
        <h2 className="text-xl sm:text-2xl font-bold text-center mb-4 sm:mb-6">
          Choose Your Plan
        </h2>
        <p className="text-center text-sm sm:text-base text-red-600 mb-6">
          (If You have crossed your current plan's limit, you can choose to
          upgrade your plan to a new plan)
        </p>
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className={`block mx-auto px-4 py-2 cursor-pointer rounded-full font-semibold transition text-sm sm:text-base ${
                    isCurrent
